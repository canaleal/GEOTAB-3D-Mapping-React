...
import KingstonMap from "./components/KingstonMap";
    ...
    try {
      ...
      setLayers([
        ...
        },
        {
          ...
          imgPath: "SidewalkPedestrian.webp",
          showButton: true,
